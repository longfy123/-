...
class Metric(object):
    """Computes and stores the average and current value, call reset before use"""
    ...
    def update_metrics(self, y_true, y_pred):
        ...
        self.metrics = {'mae': 0.0, 'rmse': 0.0, 'mape': 0.0, 'r2': 0.0, 'crps': 0, 'mis': 0.0, 'time': 0.0}
        ...
        self.metrics['mae'], self.metrics['rmse'], self.metrics['mape'], mse, self.metrics['r2'] = self.get_metric(y_true, y_pred)
    ...
    def __str__(self):
        """For print"""
        return f"{self.metrics['mae']:<7.2f}{self.metrics['rmse']:<7.2f}{self.metrics['mape']:<7.2f}{self.metrics['r2']:<7.4f}{self.metrics['crps']:<7.2f} {self.metrics['mis']:<7.2f} | {self.best_metrics['epoch'] + 1:<4} "
